...
public class registrar_login extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					registrar_login frame = new registrar_login("faMukeshJ",1);
	 ...
	 * @throws SQLException 
	 */
	public registrar_login(String fid,int flag) throws SQLException {
		...
		JLabel lblFacultyPortal = new JLabel("REGISTRAR PORTAL");
		lblFacultyPortal.setFont(new Font("Tahoma", Font.BOLD, 16));
		lblFacultyPortal.setBounds(264, 45, 176, 14);
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				submittedApplication sub;
				try {
					sub = new submittedApplication(fid,flag);
