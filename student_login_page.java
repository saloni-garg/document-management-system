...
public class student_login_page extends JFrame {
	...
	public static void main(String[] args) throws SQLException {
					...
					student_login_page frame = new student_login_page("16ucs111",1);
	...
	String fidv;
	public student_login_page(String fid,int flag) throws SQLException {
